...
**WhatsApp not connecting after upgrade:** WhatsApp is now a separate channel, not bundled in core. Run `/add-whatsapp` to install it. Existing auth credentials and groups are preserved.
